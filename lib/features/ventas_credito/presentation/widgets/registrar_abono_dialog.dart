...
/// expone a nivel de módulo para que ventas_credito_screen.dart arme los
...
class RegistrarAbonoDialog extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<RegistrarAbonoDialog> createState() =>
      _RegistrarAbonoDialogState();
}
...
class _RegistrarAbonoDialogState extends ConsumerState<RegistrarAbonoDialog> {
  ...
  Future<void> _guardar() async {
    ...
    if (_montoAbonado > widget.credito.saldoPendiente + _interes + 0.01) {
      setState(
        () => _error =
            'El abono no puede superar el saldo pendiente (${formatearMoneda(widget.credito.saldoPendiente + _interes)})',
      );
      return;
    }
    setState(() {
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _filaSoloLectura(
                      'Saldo anterior',
                      formatearMoneda(widget.credito.saldoPendiente),
                    ),
                    const SizedBox(height: 14),
                    CampoTecladoCompacto(
